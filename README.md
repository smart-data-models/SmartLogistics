...
[Open License](https://github.com/smart-data-models//SmartLogistics/blob/master//LICENSE.md)
...
The Smart Data Models board (FIWARE Foundation, TM Forum, OASC and IUDX) are leading a joint collaboration program to support the use of compatible common data models that underpin a digital market of interoperable and replicable smart solutions in multiple sectors. 

This GitHub repository contains links to the repositories where different groups of data models are contained. Data models are documented in JSON Schema and automatic documentation in multiple languages are generated based on the schemas. 
